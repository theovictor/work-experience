...
import breno from '../../assets/img/breno.jpg';
import evandro from '../../assets/img/evandro.jpg';
            ...
            <Col lg="6">
              <Card className="card-profile overflow-hidden z-index-2 border-0" style={{borderRadius: '15px'}}>
                <Row>
                  <Col lg="4" md="6" className="pe-lg-0">
                    <div className="p-3 pe-md-0">
                      <img className="w-100 rounded-circle shadow" src={breno} alt="" />
                    </div>
                  </Col>
                  <Col lg="8" md="6" className="ps-lg-0 my-auto">
                    <Card.Body>
                      <h5 className="mb-0">Breno Nogueira Araújo</h5>
                      <h6 className="text-info">Software Developer</h6>
                      <a href="https://github.com/brenonogueira" className={styles.Link}>github.com/brenonogueira</a>
                    </Card.Body>
                  </Col>
                </Row>
              </Card>
            ...
            <Col lg="6">
              <Card className="card-profile overflow-hidden mt-lg-0 mt-5 z-index-2 border-0" style={{borderRadius: '15px'}}>
                <Row>
                  <Col lg="4" md="6" className="pe-lg-0">
                    <div className="p-3 pe-md-0">
                      <img className="w-100 rounded-circle shadow" src={evandro} alt=""/>
                    </div>
                  </Col>
                  <Col lg="8" md="6" className="ps-lg-0 my-auto">
                    <Card.Body>
                      <h5 className="mb-0">Evandro Batista</h5>
                      <h6 className="text-info">Software Developer</h6>
                      <a href="https://github.com/EVANDRO-BATISTA" className={styles.Link}>github.com/EVANDRO-BATISTA</a>
                    </Card.Body>
                  </Col>
                </Row>
              </Card>
